...
def compare(a_count,b_count,guess):
  if a_count > b_count:
    return guess == "A"
  else:
    return guess == "B"
...
while not end:
  ...
  while account_a == account_b:
    account_b = random_account()
  combined_a = combined(account_a)
  combined_b = combined(account_b) 
  ...
  guess = input("whos has more followers? A or B ").upper()
  value = compare(a_count,b_count,guess)
  if value :
    score += 1
    print(f"your right : your current score {score}")
  else:
    print(f"your wrong : your final score {score}")
    end = Trues
